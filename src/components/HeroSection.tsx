...
const UNLOCK_AFTER_MS = 2.5 * 60 * 1000; // 2 minutos e 30 segundos
...
const HeroSection = ({ onUnlock }: HeroSectionProps) => {
  ...
  useEffect(() => {
    ...
    s.src =
      "https://scripts.converteai.net/3726174e-6009-479b-8521-47fffd3c0c75/players/69a9806aa61fe7c3c1d7b32c/v4/player.js";
    s.async = true;
  ...
  return (
    <section className="relative min-h-[100dvh] sm:min-h-screen flex flex-col items-center justify-center section-padding section-container overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto text-center">
        {/* Conteúdo antes do vídeo: só aparece após unlock, com fade suave */}
        {unlocked && (
          <motion.div
            {...fadeSoft}
          ...
          >
            ...
            <h1 className="text-xl min-[380px]:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight text-foreground mb-3 sm:mb-5 md:mb-6">
              Como lucrar mais de 90 mil por hectare com a{" "}
              <span className="text-primary">Moringa</span> em 2026
            </h1>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto mb-5 sm:mb-8 md:mb-10 leading-relaxed">
              Assista ao vídeo e descubra como produtores estão alcançando alta
              rentabilidade por hectare com a moringa em 2026.
            </p>
          </motion.div>
        )}

        {/* Vídeo sempre visível, não remonta — continua rodando */}
        <div className="relative aspect-video max-w-3xl mx-auto rounded-2xl overflow-hidden mb-8 shadow-2xl border border-border">
          <vturb-smartplayer
            id="vid-69a9806aa61fe7c3c1d7b32c"
            style={{ display: "block", margin: "0 auto", width: "100%" }}
          />
        </div>

        {/* Botão: troca suave entre mensagem e CTA */}
